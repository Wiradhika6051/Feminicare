...
object DummyData {
    ...
    val articles = listOf(
        ArticleDummy(
            "Siklus Menstruasi : Definisi dan Siklus", R.drawable.article1, """
    ...
    """.trimIndent()
        ...
        ArticleDummy(
            "Apa itu Periode “Normal” ?", R.drawable.article2, """
    ...
    """.trimIndent()
        ...
        ArticleDummy(
            "Mitos dan Fakta tentang Menstruasi", R.drawable.article3, """
